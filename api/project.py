...
def add_person():
    ...
    if data is None:
        return jsonify({'Response Error Message': 'Invalid JSON data. Expected a JSON object with "name" and "age" attributes.'}), 400
    ...
    return jsonify({'Successful Response Message': 'Person added successfully'}), 201
